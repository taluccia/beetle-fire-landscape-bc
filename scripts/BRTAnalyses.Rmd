...
# MODEL F7 & F8: Remove prefire vegetationvariable.
...
```{r}
save(brt.modelF7, file = "../output/finalmodels_mt/BRTF7_model_data_output.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../output/finalmodels_mt/BRTF7_model_data_output.rda")
```
...
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF7_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.modelF7)
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF7_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.modelF7.sum, '../output/finalmodels_mt/2020-02-01_BRT_modelF7_sum.csv', row.names = F)
BRT.modelF7.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.modelF7.relinf, '../output/finalmodels_mt/2020-02-01_BRT_modelF7_relinf.csv', row.names = F)
```
...
```{r}
save(brt.modelF8, file = "../output/finalmodels_mt/BRTF8_model_data_output.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../output/finalmodels_mt/BRTF8_model_data_output.rda")
```
...
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF8_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.modelF8)
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF8_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.modelF8.sum, '../output/finalmodels_mt/2020-02-01_BRT_modelF8_sum.csv', row.names = F)
BRT.modelF8.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.modelF8.relinf, '../output/finalmodels_mt/2020-02-01_BRT_modelF8_relinf.csv', row.names = F)
```
...
```{r}
save(brt.modelF9, file = "../output/finalmodels_mt/BRTF9_model_data_output.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../output/finalmodels_mt/BRTF9_model_data_output.rda")
```
...
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF9_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.modelF9)
dev.print(pdf, "../figs/finalmodels_mt/2020-02-01_BRT_modelF9_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.modelF9.sum, '../output/finalmodels_mt/2020-02-01_BRT_modelF9_sum.csv', row.names = F)
BRT.modelF9.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.modelF9.relinf, '../output/finalmodels_mt/2020-02-01_BRT_modelF9_relinf.csv', row.names = F)
```
