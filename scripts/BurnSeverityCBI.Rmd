...
```{r}
field = read.csv("../data/2018-12-10_Entiako_CBI.csv", header = TRUE, sep = ",", strip.white = TRUE)
head(field)
...
# CBI plus dNBR from GEE

## Data
```{r}
cbigee = read.csv("../data/2018-12-11_encbi-gee.csv", header = TRUE, sep = ",", strip.white = TRUE)
head(cbigee)
