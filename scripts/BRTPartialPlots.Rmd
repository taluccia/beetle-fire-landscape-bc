...
legend <- get_legend(legend.manuscript) 
...
```{r}
ocol1 = ggdraw() + draw_label('Outbreak severity included', size = 12, fontface = 'bold') 
ocol2 = ggdraw() + draw_label('Outbreak severity excluded', size = 12, fontface = 'bold') 
oheader2 = cowplot::plot_grid(ocol1, ocol2, ncol=2)
oheader2
```
...
### Full figure with legend on Right
```{r fig.height=7, fig.width=6}
( grid_final2 = cowplot::plot_grid(oheader2, grid_all3, ncol=1, rel_heights = c(0.04, 1))  )
```
