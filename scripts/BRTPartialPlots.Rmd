...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2019-09-20_partialplots_legendBottom.tiff", plot = grid_final1 , width = 6, height = 7, units = c("in"), dpi=600 )
```
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2019-09-24_partialplots_legendright.tiff", plot = grid_final2 , width = 6, height = 7, units = c("in"), dpi=600 )
```
...
grid_all4 = cowplot::plot_grid(all_mod_plots4$ndviprefire, all_mod_plots4$fwi, all_mod_plots4$elevation, all_mod_plots4$dndmi,  all_mod_plots3$ndviprefire, all_mod_plots3$fwi, all_mod_plots3$elevation,  legend4, nrow = 2) + 
   draw_label("dead/sparse", x = .1, y = .59, size = 10) +
   draw_label("live/dense", x = .2, y = .59, size = 10) +
   draw_label("dead/sparse", x = .1, y = .1, size = 10) +
   draw_label("live/dense", x = .2, y = .1, size = 10) +
   draw_label("moderate", x = .35, y = .59, size = 10) +
   draw_label("extreme", x = .45, y = .59, size = 10) +
   draw_label("moderate", x = .35, y = .1, size = 10) +
   draw_label("extreme", x = .45, y = .1, size = 10) +
   draw_label("low", x = .57, y = .59, size = 10) +
   draw_label("high", x = .7, y = .59, size = 10) +
   draw_label("low", x = .57, y = .1, size = 10) +
   draw_label("high", x = .7, y = .1, size = 10) +
   draw_label("no\nmortality", x = .82, y = .6, size = 10) +
   draw_label("high\nmortality", x = .95, y = .6, size = 10) +
   draw_label("(a)", x = .05, y = .98, size = 10) +
   draw_label("(b)", x = .3, y = .98, size = 10) +
   draw_label("(c)", x = .55, y = .98, size = 10) +
   draw_label("(d)", x = .8, y = .98, size = 10) +
   draw_label("(e)", x = .05, y = .48, size = 10) +
   draw_label("(f)", x = .3, y = .48, size = 10) +
   draw_label("(g)", x = .55, y = .48, size = 10)
grid_all4
```


```{r}
row1 = ggdraw() + draw_label('Outbreak severity included', size = 12, fontface = 'bold', angle = 90) 
row2 = ggdraw() + draw_label('Outbreak severity excluded', size = 12, fontface = 'bold', angle = 90) 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2019-11-19_partialplots_legendright_poster.tiff", plot = grid_final4, width = 15, height = 7, units = c("in"), dpi=600 )
```
**THE END**