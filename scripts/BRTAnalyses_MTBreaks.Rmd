...
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model1.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model1.3)
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model1.3_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model1.3.sum, '../output/finalmodels_mt/2021-01-21_BRT_model1.3_sum.csv', row.names = F)
BRT.model1.3.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model1.3.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model1.3_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.1)
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.1_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model2.1.sum, '../output/finalmodels_mt/2021-01-21_BRT_model2.1_sum.csv', row.names = F)
BRT.model2.1.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model2.1.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model2.1_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.2)
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.2_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model2.2.sum, '../output/finalmodels_mt/2021-01-21_BRT_model2.2_sum.csv', row.names = F)
BRT.model2.2.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model2.2.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model2.2_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.3)
dev.print(pdf, "../figs/finalmodels_mt/2021-01-21_BRT_model2.3_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model2.3.sum, '../output/finalmodels_mt/2021-01-21_BRT_model2.3_sum.csv', row.names = F)
BRT.model2.3.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model2.3.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model2.3_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.1)
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.1_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.1.sum, '../output/finalmodels/2021-01-21_BRT_model3.1_sum.csv', row.names = F)
BRT.model3.1.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.1.relinf, '../output/finalmodels/2021-01-21_BRT_model3.1_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.2)
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.2_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.2.sum, '../output/finalmodels/2021-01-21_BRT_model3.2_sum.csv', row.names = F)
BRT.model3.2.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.2.relinf, '../output/finalmodels/2021-01-21_BRT_model3.2_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.3)
dev.print(pdf, "../figures/finalmodels/2021-01-21_BRT_model3.3_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.3.sum, '../output/finalmodels/2021-01-21_BRT_model3.3_sum.csv', row.names = F)
BRT.model3.3.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.3.relinf, '../output/finalmodels/2021-01-21_BRT_model3.3_relinf.csv', row.names = F)
```
