...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model1.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model1.3)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model1.3_fits_plots.pdf")
dev.off()
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.1)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.1_fits_plots.pdf")
dev.off()
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.2)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.2_fits_plots.pdf")
dev.off()
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2.3)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model2.3_fits_plots.pdf")
dev.off()
```
...
```{r}
save(brt.model3.1, file = "../output/finalmodels_mt/BRT3.1_model_data_output.rda")
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.1)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.1_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.1.sum, '../output/finalmodels_mt/2021-01-21_BRT_model3.1_sum.csv', row.names = F)
BRT.model3.1.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.1.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model3.1_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model3.2, file = "../output/finalmodels_mt/BRT3.2_model_data_output.rda")
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.2)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.2_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.2.sum, '../output/finalmodels_mt/2021-01-21_BRT_model3.2_sum.csv', row.names = F)
BRT.model3.2.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.2.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model3.2_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model3.3, file = "../output/finalmodels_mt/BRT3.3_model_data_output.rda")
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3.3)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_model3.3_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.model3.3.sum, '../output/finalmodels_mt/2021-01-21_BRT_model3.3_sum.csv', row.names = F)
BRT.model3.3.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.3.relinf, '../output/finalmodels_mt/2021-01-21_BRT_model3.3_relinf.csv', row.names = F)
```
