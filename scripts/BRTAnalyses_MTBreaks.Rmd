...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_modelF1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.modelF1)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_modelF1_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.modelF1.sum, '../output/finalmodels_mt/2021-01-21_BRT_modelF1_sum.csv', row.names = F)
BRT.modelF1.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.modelF1.relinf, '../output/finalmodels_mt/2021-01-21_BRT_modelF1_relinf.csv', row.names = F)
```
...
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_modelF2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.modelF2)
dev.print(pdf, "../figures/finalmodels_mt/2021-01-21_BRT_modelF2_fits_plots.pdf")
dev.off()
```
...
write.csv(BRT.modelF2.sum, '../output/finalmodels_mt/2021-01-21_BRT_modelF2_sum.csv', row.names = F)
BRT.modelF2.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.modelF2.relinf, '../output/finalmodels_mt/2021-01-21_BRT_modelF2_relinf.csv', row.names = F)
```
